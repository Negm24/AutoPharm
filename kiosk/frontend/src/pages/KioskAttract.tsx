...
export default function KioskAttract() {
  ...
  return (
    <div
      className="flex h-full w-full cursor-pointer select-none items-center justify-center bg-outer-ground"
      ...
      tabIndex={0}
    >
      <div className="flex flex-col gap-8 bg-chrome-ground text-white p-8">
        <div className="flex flex-1 gap-8">
          <div className="flex flex-1 flex-col justify-between">
            <div>
              ...
              <h1 className="mt-5 text-[52px] font-bold leading-[1.1] tracking-tight">
                Medicine,<br />
                without the<br />
                queue.
              </h1>
              <p className="mt-3 text-lg leading-relaxed text-text-dim" style={{ maxWidth: 400 }}>
                {t('kiosk.subtitle')}
              </p>
            </div>
          ...
          >
            <div
              className="flex h-70 flex-col items-center justify-center gap-2 rounded-lg border border-dashed bg-black/20 text-text-muted"
            ...
            <div className="flex gap-2">
              ...
              <div className="h-1 w-4 rounded-full bg-[#3f4361]" />
              <div className="h-1 w-4 rounded-full bg-[#3f4361]" />
            </div>
